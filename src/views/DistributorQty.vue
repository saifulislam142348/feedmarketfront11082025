      ...
      <table class="min-w-full table-fixed border-collapse text-sm">
        ...
        <tbody>
          <tr
            ...
            :key="row.distributor_name + '-' + row.year"
...
async function fetchData() {
  try {
    ...
    if (sales_officer.value) params.sales_officer = sales_officer.value
