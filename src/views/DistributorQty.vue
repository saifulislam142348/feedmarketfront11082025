            ...
            <table class="min-w-full table-fixed border-collapse text-sm">
                <thead class="bg-blue-600 text-white sticky top-0 z-10">
                    <tr>
                        ...
                        <th class="px-4 py-2 border border-blue-700 w-10 text-left">Region Head</th>
                        ...
                        <td class="px-4 py-2 border border-gray-300 font-semibold text-gray-800">
                            ...
                            <div class="relative group inline-block">
                                ...
                                <span :class="{
                                    ...
                                    'text-red-700 bg-red-100 border border-red-400 rounded-lg px-1 py-0.5 ': row.agent_type !== 'Credit Agent' && row.agent_type !== 'Cash Agent','text-xs': true}">
