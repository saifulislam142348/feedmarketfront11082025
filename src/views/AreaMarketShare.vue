<template>
  <div class="p-6 mx-auto">
    <h2 class="text-3xl font-bold mb-6">Area Market Share Bag Qty</h2>
...
async function fetchData(page = 1) {
  try {
    ...
    const res = await api.get(`market/geography/area-wise-market?${params.toString()}`)
